		...
		<div class="container">
			<div class="products">
				<div class="product">
					...
					<div class="shop">
						<a href="https://omaxstressremedy.com/cart/buybutton.php?id=MtHwcp07c06I75GI5utK-g"><div class="shop-btn">Buy Now</div></a>
					</div>
					<hr>
					<div class="links">
				...
				<div class="product">
					...
					<div class="shop">
						<a href="https://omaxstressremedy.com/cart/buybutton.php?id=9ItCyrYei0CNi_JKW0S5Tw"><div class="shop-btn">Buy Now</div></a>
					</div>
					<hr>
					<div class="links">
