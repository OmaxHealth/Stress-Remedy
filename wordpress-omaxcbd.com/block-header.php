...
<head>
	...
	<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-MRL9544');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MRL9544" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->

<header>
	<div class="header-top">
		<div class="container">
			<?php if (get_query_var('offer') != 'lp1004'){ ?>
			<div id="toggle-bars">
				<div class="bar"></div>
			</div>
			<?php } ?>
		...
		<div id="close-btn"></div>
			<nav>
				<ul>
					...
					<li><a href="<?php bloginfo('url'); ?>/about-cbd/">About CBD</a></li>
					<li><a href="<?php bloginfo('url'); ?>/reviews/">Reviews</a></li>
					<li><a href="<?php bloginfo('url'); ?>/faq/">FAQs</a></li>
