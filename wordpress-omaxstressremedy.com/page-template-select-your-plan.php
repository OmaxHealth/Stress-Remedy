			...
			<div class="container">
				<div class="flexbox">
					<div class="box">
						...
						<div class="shop">
							<a href="https://omaxstressremedy.com/cart/buybutton.php?id=59DStqcJ3kaR_GUGaOwqqg"><div class="shop-btn">Order Now</div></a>
						</div>
					</div>
					<div class="box">
						...
						<div class="shop">
							<a href="https://omaxstressremedy.com/cart/buybutton.php?id=L0OD-oawwU-WKxyQHSCflQ"><div class="shop-btn">Order Now</div></a>
						</div>
					</div>					
				</div>
			</div>
